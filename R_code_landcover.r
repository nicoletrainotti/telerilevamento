...
codice modificato con prof e con piu commenti
#TOPIC 5 LANDCOVER  #analisi temporale del cambiamento nell'uso del suolo
...
# build a dataframe
cover <- c("Forest","Agriculture")   #classi 
percent_1992 <- c(89.83, 10.16)      #valori in % del 92
percent_2006 <- c(52.06, 47.93)      #valori in % del 06

percentages <- data.frame(cover, percent_1992, percent_2006)
percentages  #è il dataframe
...
grid.arrange(p1, p2, nrow=1)  #è come dire p1+p2 ma infatti uso patchwork che è molot piu veloce
